...
description: One builder's flight case — 32 die-cut vinyl stickers accreted on scuffed black laminate, framed in riveted aluminium.
colors:
...
corner braces framing the viewport, and years of die-cut vinyl stickers accreted on the lid: 32
...
one loud caution yellow — plus 32 per-project accents that arrive with the stickers, not from
this palette.
